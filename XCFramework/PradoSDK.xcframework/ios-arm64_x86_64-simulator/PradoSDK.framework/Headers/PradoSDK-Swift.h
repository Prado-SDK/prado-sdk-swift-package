...
#ifndef PRADOSDK_SWIFT_H
#define PRADOSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PradoSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8PradoSDK12KPBannerView")
...
SWIFT_CLASS("_TtC8PradoSDK7KPError")
...
@protocol PradoInitDelegate;

SWIFT_CLASS_NAMED("Prado")
@interface Prado : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Prado * _Nonnull instance;)
+ (Prado * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)initializeWithPublisherID:(NSString * _Nonnull)publisherID securityToken:(NSString * _Nonnull)securityToken delegate:(id <PradoInitDelegate> _Nonnull)delegate;
...
@class PradoBannerView;
@class PradoError;

SWIFT_PROTOCOL("_TtP8PradoSDK19PradoBannerDelegate_")
@protocol PradoBannerDelegate
...
@protocol PradoBidRequestDelegate;

SWIFT_CLASS_NAMED("PradoBannerView")
@interface PradoBannerView : KPBannerView
- (void)setDelegateWithDelegate:(id <PradoBannerDelegate> _Nonnull)delegate;
@property (nonatomic, strong) id <PradoBannerDelegate> _Nullable delegate;
+ (void)requestBidWithDelegate:(id <PradoBidRequestDelegate> _Nonnull)delegate;
+ (NSString * _Nullable)getSignal SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("PradoBid")
@interface PradoBid : KPBid
@end


SWIFT_PROTOCOL("_TtP8PradoSDK23PradoBidRequestDelegate_")
@protocol PradoBidRequestDelegate
- (void)onPradoBidResponse:(PradoBid * _Nonnull)bid;
- (void)onPradoError:(PradoError * _Nonnull)error;
@end


SWIFT_CLASS_NAMED("PradoError")
@interface PradoError : NSObject
...
SWIFT_PROTOCOL("_TtP8PradoSDK15SDKInitDelegate_")
...
SWIFT_PROTOCOL("_TtP8PradoSDK17PradoInitDelegate_")
@protocol PradoInitDelegate <SDKInitDelegate>
@end

@protocol PradoInterstitialDelegate;
@class UIViewController;

SWIFT_CLASS_NAMED("PradoInterstitialAd")
@interface PradoInterstitialAd : NSObject
+ (void)loadWithDelegate:(id <PradoInterstitialDelegate> _Nonnull)delegate;
+ (void)loadWithBid:(PradoBid * _Nonnull)bid delegate:(id <PradoInterstitialDelegate> _Nonnull)delegate;
...
SWIFT_PROTOCOL("_TtP8PradoSDK25PradoInterstitialDelegate_")
@protocol PradoInterstitialDelegate
...
@protocol PradoRewardedDelegate;

SWIFT_CLASS_NAMED("PradoRewardedAd")
@interface PradoRewardedAd : NSObject
+ (void)loadWithDelegate:(id <PradoRewardedDelegate> _Nonnull)delegate;
+ (void)loadWithBid:(PradoBid * _Nonnull)bid delegate:(id <PradoRewardedDelegate> _Nonnull)delegate;
- (void)showWithViewController:(UIViewController * _Nonnull)viewController;
- (BOOL)isLoaded SWIFT_WARN_UNUSED_RESULT;
+ (void)requestBidWithDelegate:(id <PradoBidRequestDelegate> _Nonnull)delegate;
+ (NSString * _Nullable)getSignal SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP8PradoSDK21PradoRewardedDelegate_")
@protocol PradoRewardedDelegate
...
SWIFT_CLASS("_TtC8PradoSDK12ToastMessage")
...
SWIFT_CLASS("_TtC8PradoSDK7UIUtils")
